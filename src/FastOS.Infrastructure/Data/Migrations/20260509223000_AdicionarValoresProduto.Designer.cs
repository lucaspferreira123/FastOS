...
namespace FastOS.Infrastructure.Migrations
{
    ...
    [Migration("20260509223000_AdicionarValoresProduto")]
    partial class AdicionarValoresProduto
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FastOS.Domain.Entities.ApplicationUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FastOS.Domain.Entities.ClienteEntity", b =>
                {
            ...
            modelBuilder.Entity("FastOS.Domain.Entities.ItemOrdemServicoEntity", b =>
                {
            ...
            modelBuilder.Entity("FastOS.Domain.Entities.OrcamentoEntity", b =>
                {
            ...
            modelBuilder.Entity("FastOS.Domain.Entities.OrdemServicoEntity", b =>
                {
                    b.Property<int>("idOrdemServico")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FastOS.Domain.Entities.StatusEntity", b =>
                {
                    b.Property<int>("idStatus")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FastOS.Domain.Entities.UsuarioEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FastOS.Domain.Entities.ItemOrdemServicoEntity", b =>
                {
                    b.HasOne("FastOS.Domain.Entities.OrdemServicoEntity", "OrdemServico")
                        .WithMany("Itens")
            ...
            modelBuilder.Entity("FastOS.Domain.Entities.OrcamentoEntity", b =>
                {
                    b.HasOne("FastOS.Domain.Entities.OrdemServicoEntity", "OrdemServico")
                        .WithOne("Orcamento")
                        .HasForeignKey("FastOS.Domain.Entities.OrcamentoEntity", "idOrdemServico")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("FastOS.Domain.Entities.ApplicationUser", null)
                        .WithMany()
